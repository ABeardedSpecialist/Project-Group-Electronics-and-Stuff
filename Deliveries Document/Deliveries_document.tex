...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|L{8cm}|L{2.5cm}|L{2.5cm}|}
		...
		1           & The webshop must contain any number of products.                                                                                     &    Delivery 1      &        \\ \hline
		1.1         & All information about the products shall be stored in the database.                                                                  &     Delivery 1     &        \\ \hline
		1.1.1       & \begin{tabular}[c]{@{}l@{}}product must have: \\ -Product name\\ -Category\\ -Quantity\\ -Price\\ -Description\\ -Image\end{tabular} &    Delivery 1      &        \\ \hline
		1.1.2       & All products will be pre-defined to categories (Monitors,Computers, Etc.)                                                            &     Delivery 2     &        \\ \hline
		1.2         & When an order is placed it must be added to the database                                                                             &   Delivery 3       &        \\ \hline
		1.2.1       & When an order is placed the quantity of the products must change                                                                     &    Delivery 3      &        \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|L{8cm}|L{2.5cm}|L{2.5cm}|}
		\hline
		\textbf{ID} & \textbf{Requirement}                                                       & Deadline & Status \\ \hline
		3           & The webshop shall have an Admin system where an administrator can log on   &   Delivery 1       &        \\ \hline
		3.1         & Administrator accounts and passwords shall be stored in the database.      &  Delivery 1        &        \\ \hline
		3.2         & An administrator must be able to add a new product                         &  Delivery 1        &        \\ \hline
		3.2.1       & An administrator must be able to remove a product                          &     Delivery 1     &        \\ \hline
		3.2.2       & An administrator must be able to change information about a product        &   Delivery 1       &        \\ \hline
		3.2.3       & An administrator must be able to add a category                            &     Delivery 2     &        \\ \hline
		3.2.4       & An administrator must be able to remove a category                         &     Delivery 2     &        \\ \hline
		3.2.5       & An administrator must be able to change information about a category       &   Delivery 2       &        \\ \hline
		3.3         & An administrator must be able to add a new administrator account           &     Delivery 4     &        \\ \hline
		3.3.1       & An administrator must be able to remove a administrator account            &    Delivery 4      &        \\ \hline
		3.4         & An administrator must be able to view all orders                           &     Delivery 3     &        \\ \hline
		3.4.1       & An administrator must be able update the order status on every order       &   Delivery 5       &        \\ \hline
		3.4.2       & The order status can only be New, Shipped, Delayed, Delivered and Returned &     Delivery 5     &        \\ \hline
		\end{tabular}
		\end{table}
